...
{
  GameStatus="start";
document.getElementById("status").innerHTML="3,2,1 Inisia";
...
function game(){
  ...
  console.log("narisx="+noseX+ "narisy="+noseY);
  ...
  if(gameConfig.status==='start'){
    ...
    text("juega con la naris y presiona el boton de jugar para inisiar", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
...
//deben cumplirse las 3 condiciones, tecla jugar presionada, estatus de carga y deteccion de nariz
 ...
 document.getElementById("status").innerHTML="juego cargado al 100%";
